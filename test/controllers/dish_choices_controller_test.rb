...
class DishChoicesControllerTest < ActionController::TestCase
  ...
  test "should create dish_choice" do
    assert_difference('DishChoice.count') do
      post :create, dish_choice: { checked: @dish_choice.checked, content: @dish_choice.content, desc: @dish_choice.desc, input_type: @dish_choice.input_type, must: @dish_choice.must, name: @dish_choice.name, store_id: @dish_choice.store_id }
    end
  ...
  test "should update dish_choice" do
    patch :update, id: @dish_choice, dish_choice: { checked: @dish_choice.checked, content: @dish_choice.content, desc: @dish_choice.desc, input_type: @dish_choice.input_type, must: @dish_choice.must, name: @dish_choice.name, store_id: @dish_choice.store_id }
    assert_redirected_to dish_choice_path(assigns(:dish_choice))
  end
