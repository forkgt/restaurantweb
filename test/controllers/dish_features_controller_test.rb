...
class DishFeaturesControllerTest < ActionController::TestCase
  ...
  test "should create dish_feature" do
    assert_difference('DishFeature.count') do
      post :create, dish_feature: { desc: @dish_feature.desc, name: @dish_feature.name, rank: @dish_feature.rank, store_id: @dish_feature.store_id }
    end
  ...
  test "should update dish_feature" do
    patch :update, id: @dish_feature, dish_feature: { desc: @dish_feature.desc, name: @dish_feature.name, rank: @dish_feature.rank, store_id: @dish_feature.store_id }
    assert_redirected_to dish_feature_path(assigns(:dish_feature))
  end
